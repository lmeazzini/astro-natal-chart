...
class TestAvatarUpload:
    ...
    async def test_upload_avatar_jpeg(self, client: AsyncClient, auth_headers: dict):
    ...
    async def test_delete_avatar(self, client: AsyncClient, auth_headers: dict):
...
class TestPublicProfile:
    ...
    @pytest.fixture
    async def public_user(self, db_session: AsyncSession, test_user_factory) -> User:
    ...
    @pytest.fixture
    async def private_user(self, db_session: AsyncSession, test_user_factory) -> User:
    ...
    async def test_get_public_profile_success(self, client: AsyncClient, public_user: User):
    ...
    async def test_get_private_profile_forbidden(self, client: AsyncClient, private_user: User):
...
class TestUserProfileUpdate:
    ...
    async def test_update_user_type(self, client: AsyncClient, auth_headers: dict):
    ...
    async def test_update_social_links(self, client: AsyncClient, auth_headers: dict):
    ...
    async def test_update_specializations(self, client: AsyncClient, auth_headers: dict):
    ...
    async def test_update_specializations_too_many(self, client: AsyncClient, auth_headers: dict):
    ...
    async def test_update_professional_since(self, client: AsyncClient, auth_headers: dict):
