...
variable "availability_zone" {
  description = "Primary availability zone for all resources (cost optimization)"
  type        = string
  default     = "us-east-1a"
}

variable "availability_zone_secondary" {
  description = "Secondary availability zone for RDS subnet group (required by AWS)"
  type        = string
  default     = "us-east-1b"
}
...
variable "database_subnet_cidr" {
  description = "CIDR block for the primary database subnet (RDS, ElastiCache)"
  type        = string
  default     = "10.0.21.0/24"
}

variable "database_subnet_cidr_secondary" {
  description = "CIDR block for the secondary database subnet (required by RDS)"
  type        = string
