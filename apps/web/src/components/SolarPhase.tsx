    ...
    <Card className={`bg-gradient-to-br ${colorClass}`}>
        ...
        <CardTitle className="flex items-center gap-3">
          ...
          <div>
            <div className="text-lg font-semibold text-foreground">
              {solarPhase.phase_name} - {solarPhase.temperament_pt}
            </div>
            <div className="text-xs text-muted-foreground font-normal">
              {solarPhase.temperament}
            </div>
          </div>
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <p className="text-sm font-semibold text-foreground">
              {solarPhase.qualities_pt}
            </p>
            <p className="text-xs text-muted-foreground">
              {solarPhase.qualities}
            </p>
          </div>
          <div className="space-y-1">
            <p className="text-xs text-muted-foreground uppercase tracking-wide">
            ...
            <div className="flex flex-wrap gap-1">
              {solarPhase.signs_pt.map((sign, index) => (
        ...
        <div className="mt-4 pt-4 border-t border-border">
          <p className="text-xs text-muted-foreground">
            💡 A fase solar no nascimento está baseada no signo do Sol e revela o temperamento
            fundamental e as qualidades primárias da sua personalidade segundo a astrologia tradicional.
          </p>
        </div>
      </CardContent>
    </Card>
