...
down_revision: str | None = "61837bbf83a1"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_public_chart_interpretations_chart_id"),
        "public_chart_interpretations",
        ["chart_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_public_chart_interpretations_id"),
        "public_chart_interpretations",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_public_chart_interpretations_interpretation_type"),
        "public_chart_interpretations",
        ["interpretation_type"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_public_chart_interpretations_interpretation_type"),
        table_name="public_chart_interpretations",
    )
    op.drop_index(
        op.f("ix_public_chart_interpretations_id"), table_name="public_chart_interpretations"
    )
    op.drop_index(
        op.f("ix_public_chart_interpretations_chart_id"), table_name="public_chart_interpretations"
    )
