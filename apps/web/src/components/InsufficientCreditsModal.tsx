...
import { Coins, Sparkles, ShoppingCart } from 'lucide-react';
...
export function InsufficientCreditsModal({
  ...
  return (
    <>
      <Dialog open={isOpen && !showBuyCredits} onOpenChange={(open) => !open && onClose()}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <p className="text-sm text-center text-muted-foreground">
              {t(
                ...
                'Upgrade your plan or buy credits to unlock premium features.'
              )}
            </p>
          </div>
          ...
          <DialogFooter className="flex-col sm:flex-row gap-2">
            ...
            <Button variant="secondary" onClick={handleBuyCredits} className="w-full sm:w-auto">
      ...
      <BuyCreditsModal isOpen={showBuyCredits} onClose={handleCloseBuyCredits} />
    </>
  );
}
