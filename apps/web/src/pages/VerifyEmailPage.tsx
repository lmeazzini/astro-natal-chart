  ...
  const verifyEmail = useCallback(async (verificationToken: string) => {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(error.detail || 'Falha na verificação do email');
      }
      ...
      if (error instanceof Error) {
        ...
        setErrorMessage('Erro ao verificar email. Por favor, tente novamente.');
      }
    }
  }, [navigate]);
        ...
        <CardHeader className="space-y-4">
          ...
          <div>
            ...
            <CardDescription className="text-center mt-2">
              {state === 'loading' && 'Verificando seu email...'}
              {state === 'success' && 'Email verificado com sucesso!'}
              {state === 'error' && 'Falha na verificação'}
            </CardDescription>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          {state === 'success' && (
            <div className="flex flex-col items-center justify-center py-8 space-y-4">
              ...
              <div className="text-center space-y-2">
                <h3 className="text-lg font-semibold">Tudo pronto{userName && `, ${userName}`}!</h3>
          ...
          {state === 'error' && (
            <div className="flex flex-col items-center justify-center py-8 space-y-4">
              ...
              <div className="text-center space-y-2">
                <h3 className="text-lg font-semibold">Verificação Falhou</h3>
