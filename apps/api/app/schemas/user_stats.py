...
class UserStats(BaseModel):
    ...
    total_charts: int = Field(
        ..., description="Total number of active birth charts (excludes deleted)"
    )
    ...
    oauth_providers: list[str] = Field(
        ...
        description="List of connected OAuth providers (google, github, facebook)",
    )
