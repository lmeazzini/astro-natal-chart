...
\hypersetup{
  colorlinks=true,
  linkcolor=primary,    % Using primary color for links
  urlcolor=primary,
...
\renewcommand{\arraystretch}{1.5} % Better spacing
\arrayrulecolor{border} % Use border color for rules
...
\renewcommand{\arraystretch}{1.0} % Reset spacing
